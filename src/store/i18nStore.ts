...
const dictionary: Translations = {
  ...
  pizza_notes_placeholder: { es: 'Ej. Sin cebolla, extra tostada...', en: 'Ex. No onion, extra toasted...' },
  ...
  legal_privacy_p1: { es: 'Responsable del tratamiento: Néstor Pizzas, negocio de hostelería establecido en Caniles (Granada). Puede contactar con nosotros sobre el tratamiento de sus datos personales en el teléfono +34 679 76 19 87 o por correo a tupizza@nestorpizzas.es. Por motivos de seguridad, los datos completos de identificación fiscal y comercial del negocio no se publican en este documento — se facilitan únicamente bajo solicitud expresa por esa misma vía.', en: 'Data controller: Néstor Pizzas, a hospitality business established in Caniles (Granada, Spain). You can contact us regarding the processing of your personal data at +34 679 76 19 87 or by email at tupizza@nestorpizzas.es. For security reasons, the business\'s full tax and company registration details are not published in this document — they are provided only upon explicit request through the same channel.' },
  ...
  legal_terms_p1: { es: 'El presente documento regula el uso de la aplicación y web de pedidos de Néstor Pizzas, negocio de hostelería establecido en Caniles (Granada). El uso de nuestros servicios implica la aceptación de estas condiciones. Los datos completos de identificación fiscal del negocio se facilitan bajo solicitud expresa mediante comunicación oficial a tupizza@nestorpizzas.es.', en: 'This document governs the use of the Néstor Pizzas ordering app and website, a hospitality business established in Caniles (Granada, Spain). Using our services implies acceptance of these terms. Full tax registration details for the business are provided upon explicit request through official communication to tupizza@nestorpizzas.es.' },
  ...
  legal_terms_p3: { es: 'Zona de reparto: el servicio de entrega a domicilio está limitado geográficamente al núcleo urbano de Caniles y su entorno inmediato. La aplicación verifica automáticamente que la dirección de entrega esté dentro de esta zona antes de confirmar el pedido.', en: 'Delivery area: home delivery is geographically limited to the town of Caniles and its immediate surroundings. The app automatically verifies that the delivery address is within this area before confirming the order.' },
  legal_terms_p4: { es: 'Pago: aceptamos pago en efectivo, con datáfono físico en el momento de la entrega/recogida, y pago online a través de pasarela segura cuando esté disponible. En ningún caso almacenamos los datos completos de su tarjeta.', en: 'Payment: we accept cash, physical card terminal at delivery/pickup, and online payment through a secure gateway when available. We never store your full card details.' },
  ...
  legal_data_p4: { es: 'Proveedores tecnológicos: sus datos se almacenan en infraestructura de Supabase (base de datos) y Vercel (alojamiento web), proveedores que cumplen garantías adecuadas de protección de datos conforme al RGPD.', en: 'Technology providers: your data is stored on Supabase (database) and Vercel (web hosting) infrastructure, providers that meet appropriate data protection safeguards under GDPR.' },
  ...
  landing_vip_reward: { es: 'la pizza o burger que TÚ elijas de tu pedido, GRATIS', en: 'the pizza or burger YOU choose from your order, FREE' },
...
const dynamicDictionary: Record<string, string> = {
  ...
  // Badges
  'POLLO Y CARBONARA ★ NEW': 'CHICKEN & CARBONARA ★ NEW',
  'POSTRE ARTESANO ★ NEW': 'ARTISAN DESSERT ★ NEW',
  'ESPECIALIDAD CANILES': 'CANILES SPECIALTY',
  'GAJOS A ELEGIR SALSA': 'WEDGES WITH SAUCE',
  ...
  'AMERICANA': 'AMERICAN',
  'BOLOÑESA': 'BOLOGNESE',
  'CALZONE CURRY': 'CURRY CALZONE',
  'CALZONE CARBONARA': 'CARBONARA CALZONE',
  'PANNA': 'PANNA',
  'LIONESA': 'LYONNAISE',
  'CARBONARA': 'CARBONARA',
  'PATATAS FRITAS': 'FRENCH FRIES',
  'GRATINADAS CHEDDAR': 'CHEDDAR GRATIN',
  'GRATINADAS MORISCA': 'MOORISH GRATIN',
  'NUGUETTS DE POLLO': 'CHICKEN NUGGETS',
  'ALITAS DE POLLO': 'CHICKEN WINGS',
  'SPAGUETTI BOLOÑESA': 'SPAGHETTI BOLOGNESE',
  'SPAGUETTI CARBONARA': 'SPAGHETTI CARBONARA',
  'POLLO AL CURRY CON ARROZ': 'CHICKEN CURRY WITH RICE',
  'PIZZA DULCE': 'SWEET PIZZA',
  'BURGUER CRUJIENTE': "CRISPY BURGER",
  'BOCATA EXTREMEÑO': 'EXTREMAN SANDWICH',
  'BOCATA SERRANITO': 'SERRANITO SANDWICH',
  'CHEDDAR LOVE': 'CHEDDAR LOVE',
  'CABRONA': 'CABRONA',
  'PULLED BBQ': 'PULLED BBQ',
  'AGUA PEQUEÑA': 'SMALL WATER',
  'AGUA 1,5 LITROS': '1.5L WATER',
  'REFRESCOS LATA': 'CANNED SODA',
  'CERVEZA LATA': 'CANNED BEER',
  'AQUARIUS': 'AQUARIUS',
  'CERVEZA LITRO': '1L BEER',
  'REFRECO 2 LITROS': '2L SODA',
  'PATATAS GAJOS + SALSA': 'POTATO WEDGES + SAUCE',
  'ALITAS DE POLLO (6 UND)': 'CHICKEN WINGS (6 PCS)',
  'AROS DE CEBOLLA (8 UND)': 'ONION RINGS (8 PCS)',
  'REFRESCO LATA': 'CANNED SODA',
  'AGUA 500ML': '500ML WATER',
  'HELADO SANDWICH': 'ICE CREAM SANDWICH',
  'CONO DE HELADO': 'ICE CREAM CONE',
  'MEZCLA 4 QUESOS': '4 CHEESE MIX',
  'TROPICAL': 'TROPICAL',
  '3 QUESOS Y BACON': '3 CHEESES AND BACON',
  'PARA ACOMPAÑAR': 'SIDES',
  
  // Category Descriptions (Full Sentences for Exact Match)
  'HAMBURGUESAS COMPLETAS': 'FULL BURGERS',
  'AGUA, REFRESCOS Y CERVEZAS BIEN FRÍAS': 'WATER, SOFT DRINKS, AND ICE COLD BEERS',
  'NUESTRA SELECCIÓN MÁS DULCE': 'OUR SWEETEST SELECTION',
  'OFERTAS ESPECIALES Y PROMOCIONES EXCLUSIVAS': 'SPECIAL OFFERS AND EXCLUSIVE PROMOTIONS',
  'BASE DE TOMATE NATURAL Y MOZZARELLA FIOR DI LATTE — MASA ARTESANA HORNEADA AL MOMENTO': 'NATURAL TOMATO BASE AND FIOR DI LATTE MOZZARELLA — ARTISAN DOUGH BAKED TO ORDER',
  'MASA CERRADA AL HORNO CON INGREDIENTES FRESCOS': 'OVEN-BAKED CLOSED DOUGH WITH FRESH INGREDIENTS',
  'BASE DE NATA CREMOSA SIN TOMATE': 'CREAMY BASE WITHOUT TOMATO',
  'RACIONES CRUJIENTES RECIÉN HECHAS PARA COMPARTIR': 'CRISPY PORTIONS FRESHLY MADE TO SHARE',
  'COMPLEMENTOS DORADOS Y CRUJIENTES RECIÉN SALIDOS DE COCINA': 'GOLDEN AND CRISPY SIDES FRESH FROM THE KITCHEN',
  'CREA TU PROPIA PIZZA — BASE DE TOMATE, MOZZARELLA Y ORÉGANO CON LOS INGREDIENTES QUE TÚ ELIJAS': 'CREATE YOUR OWN PIZZA — TOMATO BASE, MOZZARELLA, AND OREGANO WITH YOUR CHOICE OF INGREDIENTS',
  'NUESTRA MASA ARTESANA, EXQUISITA MEZCLA DE CINCO QUESOS, UNA LÁMINA DE MASA, NUESTRA BASE Y LA SELECCIÓN QUE MÁS TE APETEZCA. *UNIDADES LIMITADAS': 'OUR ARTISAN DOUGH, EXQUISITE BLEND OF FIVE CHEESES, A SHEET OF DOUGH, OUR BASE, AND THE SELECTION YOU CRAVE THE MOST. *LIMITED UNITS',
  'NUESTRA MASA ARTESANA, EXQUISITA MEZCLA DE FIVE CHEESES, UNA LÁMINA DE MASA, NUESTRA BASE Y LA SELECCIÓN QUE MÁS TE APETEZCA. *UNIDADES LIMITADAS': 'OUR ARTISAN DOUGH, EXQUISITE BLEND OF FIVE CHEESES, A SHEET OF DOUGH, OUR BASE, AND THE SELECTION YOU CRAVE THE MOST. *LIMITED UNITS',
  'HAMBURGUESAS ESPECIALES DE FIN DE SEMANA': 'SPECIAL WEEKEND BURGERS',
  'SPAGUETTI BOLOÑESA Y CARBONARA, POLLO AL CURRY CON ARROZ Y POSTRE DE TEMPORADA': 'SPAGHETTI BOLOGNESE AND CARBONARA, CHICKEN CURRY WITH RICE, AND SEASONAL DESSERT',
  'DOS PIZZAS POR 11 EUROS. PROMOCIÓN VÁLIDA SOLO LOS JUEVES. (PULSA PARA CONFIGURAR)': 'TWO PIZZAS FOR 11 EUROS. PROMOTION VALID ONLY ON THURSDAYS. (CLICK TO CONFIGURE)'
};
