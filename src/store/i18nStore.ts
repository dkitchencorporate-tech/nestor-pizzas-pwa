...
const dictionary: Translations = {
  ...
  legal_privacy_p1: { es: 'Responsable del tratamiento: Néstor Pizzas Gourmet (CIF B-18810992), con domicilio en Calle Alcalde Felip, 9, 18810 Caniles (Granada). Puede contactar con nosotros sobre el tratamiento de sus datos personales en el teléfono +34 679 76 19 87.', en: 'Data controller: Néstor Pizzas Gourmet (Tax ID B-18810992), located at Calle Alcalde Felip, 9, 18810 Caniles (Granada, Spain). You can contact us regarding the processing of your personal data at +34 679 76 19 87.' },
  ...
  legal_terms_p1: { es: 'El presente documento regula el uso de la aplicación y web de pedidos de Néstor Pizzas Gourmet (CIF B-18810992), en Caniles (Granada). El uso de nuestros servicios implica la aceptación de estas condiciones.', en: 'This document governs the use of the Néstor Pizzas Gourmet ordering app and website (Tax ID B-18810992), Caniles (Granada, Spain). Using our services implies acceptance of these terms.' },
