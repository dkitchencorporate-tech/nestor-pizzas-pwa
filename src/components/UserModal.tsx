          ...
          {profile?.is_admin && userModalView !== 'legal' && userModalView !== 'legal-doc' && userModalView !== 'delete-account' && userModalView !== 'delete-success' ? (
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3 mb-2">
                <button type="button" onClick={handleGoogleLogin} className="flex items-center justify-center gap-2 bg-white text-gray-900 font-bold py-2.5 px-4 rounded-xl transition-all hover:bg-gray-100 text-xs sm:text-sm">
                ...
                <button type="button" onClick={handleAppleLogin} className="flex items-center justify-center gap-2 bg-black text-white border border-white/20 font-bold py-2.5 px-4 rounded-xl transition-all hover:bg-gray-900 text-xs sm:text-sm">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.04 2.26-.74 3.73-.78 2.02-.04 3.38 1.14 4.12 2.16-1.55 1.1-1.25 3.33.4 4.09-.34 1.33-1.07 2.87-2.01 4.25-.66.97-1.35 1.9-2.32 1.96V20.28zM12.03 7.25C11.97 4.7 14 2.37 16.32 2c.16 2.72-2.32 5.09-4.29 5.25z"/></svg>
                  Apple
                </button>
              </div>
